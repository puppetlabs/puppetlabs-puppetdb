...
class puppetdb (
  ...
  Optional[String[1]]                                                  $ssl_key                           = $puppetdb::params::ssl_key,
  Optional[String[1]]                                                  $ssl_cert                          = $puppetdb::params::ssl_cert,
  Optional[String[1]]                                                  $ssl_ca_cert                       = $puppetdb::params::ssl_ca_cert,
  ...
  Variant[String[0], Boolean[false]]                                   $read_database_jdbc_ssl_properties = $puppetdb::params::read_database_jdbc_ssl_properties,
  ...
  Variant[Integer[0], Pattern[/\A[0-9]+\Z/]]                           $read_conn_lifetime                = $puppetdb::params::read_conn_lifetime,
  ...
  Optional[Variant[Integer[0], Enum['absent'], Pattern[/\A[0-9]+\Z/]]] $read_database_max_pool_size       = $puppetdb::params::read_database_max_pool_size,
