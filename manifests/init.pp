...
class puppetdb (
  ...
  Stdlib::Port $listen_port                = $puppetdb::params::listen_port,
  Boolean $disable_cleartext               = $puppetdb::params::disable_cleartext,
  Boolean $open_listen_port                = $puppetdb::params::open_listen_port,
  Variant[Stdlib::Ip::Address, String[1]] $ssl_listen_address = $puppetdb::params::ssl_listen_address,
  Stdlib::Port $ssl_listen_port            = $puppetdb::params::ssl_listen_port,
  ...
  Optional $ssl_key                        = $puppetdb::params::ssl_key,
  Optional $ssl_cert                       = $puppetdb::params::ssl_cert,
  Optional $ssl_ca_cert                    = $puppetdb::params::ssl_ca_cert,
  Optional $ssl_protocols                  = $puppetdb::params::ssl_protocols,
  ...
  Boolean $manage_dbserver                 = $puppetdb::params::manage_dbserver,
  ...
  String[1] $database_host                 = $puppetdb::params::database_host,
  Stdlib::Port $database_port              = $puppetdb::params::database_port,
  ...
  Integer $gc_interval                     = $puppetdb::params::gc_interval,
  Integer $node_purge_gc_batch_limit       = $puppetdb::params::node_purge_gc_batch_limit,
  Integer $conn_max_age                    = $puppetdb::params::conn_max_age,
  Integer $conn_lifetime                   = $puppetdb::params::conn_lifetime,
  ...
  Optional[String[1]] $read_database_host  = $puppetdb::params::read_database_host,
  ...
  String $read_database_jdbc_ssl_properties = $puppetdb::params::read_database_jdbc_ssl_properties,
  ...
  Integer $read_conn_lifetime              = $puppetdb::params::read_conn_lifetime,
  Stdlib::Absolutepath $confdir            = $puppetdb::params::confdir,
  Stdlib::Absolutepath $vardir             = $puppetdb::params::vardir,
  Boolean $manage_firewall                 = $puppetdb::params::manage_firewall,
