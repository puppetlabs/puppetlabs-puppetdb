...
class puppetdb (
  ...
  Optional[String]                                                  $ssl_key                           = $puppetdb::params::ssl_key,
  Optional[String]                                                  $ssl_cert                          = $puppetdb::params::ssl_cert,
  Optional[String]                                                  $ssl_ca_cert                       = $puppetdb::params::ssl_ca_cert,
  ...
  Optional[Variant[Integer, Enum['absent'], Pattern[/\A[0-9]+\Z/]]] $read_database_max_pool_size       = $puppetdb::params::read_database_max_pool_size,
