...
class puppetdb (
  ...
  Variant[Stdlib::Port, Pattern[/\A[0-9]+\Z/]] $listen_port     = $puppetdb::params::listen_port,
  ...
  Variant[Stdlib::Port, Pattern[/\A[0-9]+\Z/]] $ssl_listen_port = $puppetdb::params::ssl_listen_port,
  ...
  Variant[Stdlib::Port, Pattern[/\A[0-9]+\Z/]] $database_port = $puppetdb::params::database_port,
  ...
  Variant[Stdlib::Port, Pattern[/\A[0-9]+\Z/]] $read_database_port         = $puppetdb::params::read_database_port,
  ...
  Variant[Integer, Pattern[/\A[0-9]+\Z/]] $read_conn_lifetime              = $puppetdb::params::read_conn_lifetime,
